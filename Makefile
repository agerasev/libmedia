...
MEDIA_D_ALL_HEADERS=$(MEDIA_HEADERS) $(MEDIA_LOCAL_HEADERS) $(MEDIA_D_HEADERS) $(MEDIA_D_LOCAL_HEADERS)
...
MEDIA_W_ALL_HEADERS=$(MEDIA_HEADERS) $(MEDIA_LOCAL_HEADERS) $(MEDIA_W_HEADERS) $(MEDIA_W_LOCAL_HEADERS)
